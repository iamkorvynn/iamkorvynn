...
- 🔭 Currently building **Synq** — an end-to-end encrypted messenger, and **ExplainMyCode** — an AI-powered coding IDE
- 🌱 Exploring LangChain/LangGraph agent orchestration, federated learning, and explainable AI (SHAP/LIME)
- 💼 Freelance full-stack developer — delivered a live production site for a paying client (Shiksha Tutorials Vasai)
- 📝 Co-authored a peer-reviewed ML research paper on mental health relapse prediction
- 🎯 Passionate about full-stack architecture, motion-heavy UI/UX, and experimental side projects

**Open To:** Internships & entry-level SWE/AI roles · Freelance/Contract work · Open-source collaboration
